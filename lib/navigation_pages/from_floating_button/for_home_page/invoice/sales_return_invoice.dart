...
Future<Uint8List> generateSalesReturnInvoicePDF(
  SalesReturnModel saleReturn,
  ...
  final customerName =
      customer?['name']?.toString().trim() ?? saleReturn.customerName;
          ...
          children: [
            ...
            pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text(
                    'Sales Return Invoice', // Changed title
                    style: pw.TextStyle(
                      font: ttf,
                      fontSize: 25,
                      fontWeight: pw.FontWeight.bold,
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      pw.Text(
                        'Return Number: ${saleReturn.returnNo}', // Changed field
                        style: pw.TextStyle(font: ttf, fontSize: 12),
                      ),
                      pw.SizedBox(height: 4),
                      pw.Text(
                      ...
                      pw.SizedBox(height: 4),
                      pw.Text(
                        'Original Invoice: ${saleReturn.originalInvoiceNo}', // Added original invoice reference
                        style: pw.TextStyle(font: ttf, fontSize: 12),
                      ),
                    ],
                  ),
            ...
            pw.Table(
              ...
              children: [
                ...
                pw.TableRow(
                  decoration: pw.BoxDecoration(color: PdfColors.red400),
                  children: [
                    _buildDataCell(
                      '',
                      ttf,
                ...
                pw.Expanded(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        saleReturn.returnReason.isNotEmpty
                            ? saleReturn.returnReason
                            : 'Goods returned as per customer request.',
                        style: pw.TextStyle(font: ttf),
                      ),
                    ],
                  ),
                  ...
                  child: pw.Container(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        _buildPricingRow('Refund Amount', '₹ 0.00', ttf),
                        _buildPricingRow(
                          'Balance',
                          '₹ ${totalAmount.toStringAsFixed(2)}',
                          ttf,
...
// === Amount in Words (same as original) ===
...
class SalesReturnModel {
  ...
  factory SalesReturnModel.fromMap(Map<String, dynamic> map) {
    return SalesReturnModel(
      ...
      originalInvoiceNo: map['original_invoice_no'] ?? '',
