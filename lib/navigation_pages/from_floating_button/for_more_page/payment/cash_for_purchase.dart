...
class PurchaseCashPage extends StatefulWidget {
  const PurchaseCashPage({Key? key}) : super(key: key);

  @override
  State<PurchaseCashPage> createState() => _PurchaseCashPageState();
}

class _PurchaseCashPageState extends State<PurchaseCashPage> {
          ...
          Expanded(
            child:
                cashTransactions.isEmpty
                    ? const Center(child: Text("No cash purchases found."))
                    : ListView.builder(
