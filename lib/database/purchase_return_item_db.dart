...
class PurchaseReturnItemDB {
  static const String tableName = 'purchase_return_item';

  // Create the purchase_return_item table
  static Future<void> createTable(Database db) async {
    await db.execute('''
      CREATE TABLE $tableName (
        ...
        FOREIGN KEY (original_item_id) REFERENCES purchase_item(id)
      )
    ''');
  }

  // Insert a new purchase return item
